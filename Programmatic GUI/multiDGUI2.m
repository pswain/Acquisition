...
handles.OmeroTags=uicontrol('Style','popupmenu','Parent',handles.experimentPanel,'Units','Normalized','Position',[.358 .059 .184 .361],'String','Tags menu','TooltipString','Choose Omero Tags for your experiment','Callback',@OmeroTags_Callback);
...
handles.unitsTotal=uicontrol('Style','popupmenu','Parent',handles.timePanel,'Units','Normalized','Position',[.429 .297 .3 .081],'String',{'s';'min';'hr'},'FontSize',10,'Callback',@unitsTotal_Callback,'TooltipString','Set units for time interval');
