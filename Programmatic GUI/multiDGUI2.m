...
handles.logpumps=uicontrol('Style','radiobutton','BackgroundColor',[0.8 0.8 0.8],'Parent',handles.flowPanel,'Units','Normalized','Position',[.78 .2 .25 .103],'String','Log pump info','Value',1,'FontSize',10,'HorizontalAlignment','Center','Callback',@logPumpInfo_Callback,'TooltipString','Select to log real info about the state of the pumps during the acquisition. If selected this feature will email you if one of the pumps stalls during the experiment. This will slow each timepoint down by around 10s.');
